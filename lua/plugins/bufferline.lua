return {
  ...
  opts = {
    options = {
      ...
      -- stylua: ignore
      close_command = function(n) require("mini.bufremove").delete(n, false) end, -- "bdelete! %d", -- can be a string | function, | false see "Mouse actions"
      -- stylua: ignore
      right_mouse_command = function(n) require("mini.bufremove").delete(n, false) end, -- can be a string | function | false, see "Mouse actions"
